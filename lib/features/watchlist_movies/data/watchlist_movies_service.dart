...
class WatchlistMoviesService {
  ...
  WatchlistMoviesService({TmdbApiClient? apiClient}) : _apiClient = apiClient ?? TmdbApiClient();

  Future<Map<String, dynamic>> getWatchlistMovies(int accountId, {int page = 1, String sortBy = 'created_at.desc'}) async {
  ...
  Future<bool> toggleWatchlistMovie({required int accountId, required int movieId, required bool isWatchlist}) async {
