...
class FavoriteTVService {
  final TmdbApiClient _apiClient;

  FavoriteTVService({TmdbApiClient? apiClient})
      : _apiClient = apiClient ?? TmdbApiClient();

  Future<Map<String, dynamic>> getFavoriteTV(
    int accountId, {
    int page = 1,
  ...
  Future<bool> toggleFavoriteTV({
    ...
    final response = await _apiClient.post(
      ...
      body: {'media_type': 'tv', 'media_id': tvId, 'favorite': isFavorite},
    );
